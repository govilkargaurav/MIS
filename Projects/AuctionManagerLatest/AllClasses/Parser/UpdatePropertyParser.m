...
@interface UpdatePropertyParser ()

@end

@implementation UpdatePropertyParser
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI
 qualifiedName:(NSString *)qualifiedName attributes:(NSDictionary *)attributeDict{
    ...
    if ([elementName isEqualToString:@"status"]) {
        ...
        status=[attributeDict valueForKey:@"success"];
...
- (void)parser:(NSXMLParser *)parser parseErrorOccurred:(NSError *)parseError{
	...
	[[NSNotificationCenter defaultCenter]postNotificationName:NOTIFICATION_GET_UPDATE_PROPERTY object:nil];
}
