...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray
{
    ...
    for (NSString *string in stringArray) {
        ...
        textButton.titleLabel.shadowColor=[UIColor darkGrayColor];
        ...
        [textButton setTitleShadowColor:[UIColor grayColor] forState:UIControlStateNormal];
        [textButton.titleLabel setShadowOffset:CGSizeMake(0.5f, 0.5f)];
