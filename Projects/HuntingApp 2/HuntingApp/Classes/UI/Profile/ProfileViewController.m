...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (userProfile)
    {
        ...
        if ([userProfile.picture length]>0 && [[[NSUserDefaults standardUserDefaults]objectForKey:LOAD_PROFILE_IMAGE_FROM_SERVER]isEqualToString:@"0"])
        {
            profilePicView.image = [UIImage imageWithData:userProfile.picture];
        ...
        else 
        {
            ...
            [[NSUserDefaults standardUserDefaults]setObject:@"0" forKey:LOAD_PROFILE_IMAGE_FROM_SERVER];
