...
@interface SaveImageViewController : UIViewController<UITextFieldDelegate,UIAlertViewDelegate,RequestWrapperDelegate,CustomMapViewControllerDelegate>
{
    ...
    IBOutlet UITextField *txtFldCustomLocation;
}
