...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (strCustomLocation) {
        
        txtFldCustomLocation.text=strCustomLocation ;
        strCustomLocation= @"";
    }
...
- (void)uploadImage
{
    ...
    if (![txtFldCustomLocation.text isEmptyString]) {
        txtFldCustomLocation.text = [txtFldCustomLocation.text stringByReplacingOccurrencesOfString:@"," withString:@";"];
        [dict setObject:txtFldCustomLocation.text forKey:KWEB_SERVICE_IMAGE_LOCATION];
    }
...
-(IBAction)SetCustomType:(id)sender{
