...
#import "AppDelegate.h"
@interface MapViewControllerViewController : UIViewController<MKMapViewDelegate,RequestWrapperDelegate,UIPopoverControllerDelegate,NotificationPickerDelegate,AlbumViewDelegate,GetImageInfoDelegate,apppickerDelegate>
{
    UIView *titleView;
    ...
    BOOL shouldReload;
    TimeLineCell *celltimeline;
}
@property (nonatomic,strong) IBOutlet CustomTimeLineFooter *view1;
@property (nonatomic,strong) IBOutlet CustomTimeLineFooter *view2;
@property (nonatomic,strong)NSMutableArray *arrPostNotificationImage;
@property (nonatomic,strong)AppDelegate *delegate;
@property (nonatomic,retain)IBOutlet UITableView *tableViewNotification;
