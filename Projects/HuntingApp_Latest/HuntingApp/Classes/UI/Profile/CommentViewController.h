...
@interface CommentViewController : UIViewController<TSAlertViewDelegate,UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,RequestWrapperDelegate,UITextFieldDelegate>
{
