...
- (void)requestWrapperDidReceiveResponse:(NSString *)response withHttpStautusCode:(HttpStatusCodes)statusCode withRequestUrl:(NSURL *)requestUrl withUserInfo:(NSDictionary *)auserInfo
{
    ...
    {
        [[NSUserDefaults standardUserDefaults] setValue:[[[[jsonDict objectForKey:@"data"] objectAtIndex:0] objectForKey:@"data"]objectForKey:@"eNotificationImageUpload"] forKey:@"eNotificationImageUpload"];
        [[NSUserDefaults standardUserDefaults] setValue:[[[[jsonDict objectForKey:@"data"] objectAtIndex:0] objectForKey:@"data"]objectForKey:@"eNotificationOthers"] forKey:@"eNotificationOthers"];
...
/* Push Device Tocken 5e2e9444b038e7c3cf400a910a39e66e6da3f0510906c49a65aeaf43a9591097 Fot Testing Purpose Only*/
/* For Actual Build Write this code [[NSUserDefaults standardUserDefaults] valueForKey:DEVICE_TOKEN] */
...
- (IBAction)logIn:(id)sender
{
    ...
    if ([self isAllTheInfoCompletelyFilled])
    {
        ...
        [userInfo setObject:@"5e2e9444b038e7c3cf400a910a39e66e6da3f0510906c49a65aeaf43a9591097" forKey:KWEB_DEVICE_TOKEN_ID];
                ...
                [store requestAccessToAccountsWithType:twitterType options:nil completion:^(BOOL granted, NSError *error){
                    ...
                    if (granted) {
                        ...
                        if (twitterAccounts.count!=0)
                        {
                            ...
                            __block SLRequest *request2  = [SLRequest requestForServiceType:SLServiceTypeTwitter
                                                                              requestMethod:SLRequestMethodGET
                                                                                        URL:[NSURL URLWithString:[NSString stringWithFormat:@"https://api.twitter.com/1.1/users/lookup.json?screen_name=%@",account.username]]
                                                                                 parameters:nil];
