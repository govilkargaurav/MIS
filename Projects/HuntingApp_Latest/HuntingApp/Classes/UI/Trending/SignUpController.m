...
- (IBAction)signUp:(id)type
{
    ...
    if (isCompletelyFilled && !isSigningUp)
    {
        ...
        [userInfo setObject:[[NSUserDefaults standardUserDefaults] valueForKey:DEVICE_TOKEN] forKey:KWEB_DEVICE_TOKEN_ID];
        ...
        NSLog(@"%f %f",avatar.size.width,avatar.size.height);
        [userInfo setObject:[NSString base64StringFromData:UIImagePNGRepresentation(avatar)] forKey:KWEB_SERVICE_AVATARBIG];
