...
- (void)setImageWithUrl:(NSString *)url {
    ...
    [_request setCacheStoragePolicy:ASIDoNotReadFromCacheCachePolicy];
...
- (void)setImageWithProfileBIG:(Profile *)aprofile
{
    profile = [aprofile retain];
    [self setImageWithUrl:[Utility getProfilePicURLBIG:profile.user_id]];
}
