...
-(void)askTransfer {
    ...
    [option1 addChild:[NSXMLNode elementWithName:@"value" stringValue:@"http://jabber.org/protocol/bytestreams"]];
    
    NSXMLElement *option2 = [NSXMLElement elementWithName:@"option"];
    [option2 addChild:[NSXMLNode elementWithName:@"value" stringValue:@"http://jabber.org/protocol/ibb"]];
