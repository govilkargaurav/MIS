...
@property(nonatomic,strong) NSMutableDictionary *_dictGroupInfo;
@property(nonatomic,strong) NSMutableDictionary *dictGroupSettings;
@property (nonatomic,strong)NSMutableArray *arrOnetoOneChat;
@property (nonatomic,strong)NSString *strTheUserId;
@property (nonatomic,readwrite) BOOL isFlag;
@end

/*
arrContent = [NSMutableArray arrayWithObjects:
