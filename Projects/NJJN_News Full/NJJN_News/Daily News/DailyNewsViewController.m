...
-(void)LoadPdf
{
    ...
    [self CancelAllDownloads];
        ...
        {
            str_2 = [NSString stringWithFormat:@"%@c=pdf&func=getPdf&iUserID=%@&iZoneID=%@&iEditionID=%@&dIssueDate=%@&vDeviceToken=%@&vUdid=%@",WebURL,[[[NSUserDefaults standardUserDefaults] objectForKey:@"UserInfo"] valueForKey:@"iUserID"],strZoneId,strEditionId,@"",[[NSUserDefaults standardUserDefaults] objectForKey:@"deviceToken"],[[NSUserDefaults standardUserDefaults] valueForKey:@"DeviceUDID"]];
        }
        else
        {
            str_2 = [NSString stringWithFormat:@"%@c=pdf&func=getPdf&iUserID=0&iZoneID=%@&iEditionID=%@&dIssueDate=%@&vDeviceToken=%@&vUdid=%@",WebURL,strZoneId,strEditionId,@"",[[NSUserDefaults standardUserDefaults] objectForKey:@"deviceToken"],[[NSUserDefaults standardUserDefaults] valueForKey:@"DeviceUDID"]];
        }
...
-(IBAction)btnDownloadPressed:(id)sender
{
    ...
    else
    {
        ...
        if([[[AppDel.arrPdf objectAtIndex:SuperViewPdfTag-1] valueForKey:@"vDownload"] isEqualToString:@"NO"] || [[[AppDel.arrPdf objectAtIndex:SuperViewPdfTag-1] valueForKey:@"vDownload"] isEqualToString:@"no"] || [[[AppDel.arrPdf objectAtIndex:SuperViewPdfTag-1] valueForKey:@"vDownload"] isEqualToString:@"No"])
        {
            NSString *strmsg = [NSString stringWithFormat:@"Please subscribe to download %@",[[AppDel.arrPdf objectAtIndex:SuperViewPdfTag-1] valueForKey:@"vTitle"]];
