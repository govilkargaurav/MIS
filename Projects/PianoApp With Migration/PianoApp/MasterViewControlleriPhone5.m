...
@interface MasterViewControlleriPhone5 ()

@end

@implementation MasterViewControlleriPhone5
...
- (void)viewDidLoad
{
    ...
    settag1=settag2=settag3=settag4=settag5=settag6=settag7=settag8=0;
    settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
    ReVerifySet=0;
    ...
    lblH.transform = CGAffineTransformMakeRotation (-(3.14)/2);
    ...
    [self LongPressToChangePassword:H];
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (touch.view == viewPassQuesAns || touch.view == viewPassInstr || touch.view == ViewPassRecovery)
        return;
    ...
    else if (CGRectContainsPoint(H.frame,currentPoint)==YES)
    {
        [self PlaySound:@"C High"];
        
        settag8=1;
        settag23=1;
        [H setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
        if (settag == 22)
        {
            if ([allTouches count] > 1)
            {
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (location.x >200)
    {
        if(location.y >495 && location.y <563 && settag1==0)
        {
            [self PlaySound:@"C Long"];
            
            settag1=1;
            settag2=settag3=settag4=settag5=settag6=settag7=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
            ...
            [H setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >425 && location.y <493 && settag2==0)
        {
            [self PlaySound:@"D Long"];
            
            settag2=1;
            settag1=settag3=settag4=settag5=settag6=settag7=settag8=0;
        ...
        else if (location.y >355 && location.y <423 && settag3==0)
        {
            [self PlaySound:@"E Long"];
            
            settag3=1;
            settag1=settag2=settag4=settag5=settag6=settag7=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >285 && location.y <353 && settag4==0)
        {
            [self PlaySound:@"F Long"];
            
            settag4=1;
            settag1=settag2=settag3=settag5=settag6=settag7=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
        ...
        else if (location.y >215 && location.y <283 && settag5==0)
        {
            [self PlaySound:@"G Long"];
            
            settag5=1;
            settag1=settag2=settag3=settag4=settag6=settag7=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >145 && location.y <213 && settag6==0)
        {
            [self PlaySound:@"A Long"];
            
            settag6=1;
            settag1=settag2=settag3=settag4=settag5=settag7=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >75 && location.y <143 && settag7==0)
        {
            [self PlaySound:@"B Long"];
            
            settag7=1;
            settag1=settag2=settag3=settag4=settag5=settag6=settag8=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >5 && location.y <73 && settag8==0)
        {
            [self PlaySound:@"C High"];
    ...
    {
        if(location.y >514 && location.y <563 && settag11==0)
        {
            [self PlaySound:@"C Long"];
            
            settag11=1;
            settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >474 && location.y <514 && settag12==0)
        {
            [self PlaySound:@"C# Long"];
            
            settag12=1;
            settag11=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >444 && location.y <474 && settag13==0)
        {
            [self PlaySound:@"D Long"];
            
            settag13=1;
            settag11=settag12=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >404 && location.y <444 && settag14==0)
        {
            [self PlaySound:@"D# Long"];
            
            settag14=1;
            settag11=settag12=settag13=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >355 && location.y <404 && settag15==0)
        {
            [self PlaySound:@"E Long"];
            
            settag15=1;
            settag11=settag12=settag13=settag14=settag16=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >304 && location.y <353 && settag16==0)
        {
            [self PlaySound:@"F Long"];
            
            settag16=1;
            settag11=settag12=settag13=settag14=settag15=settag17=settag18=settag19=settag20=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyPressedVertc.png"]];
        ...
        else if (location.y >264 && location.y <304 && settag17==0)
        {
            [self PlaySound:@"F# Long"];
            
            settag17=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag18=settag19=settag20=settag21=settag22=settag23=0;
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >234 && location.y <264 && settag18==0)
        {
            [self PlaySound:@"G Long"];
            
            settag18=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag19=settag20=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >194 && location.y <234 && settag19==0)
        {
            [self PlaySound:@"G# Long"];
            
            settag19=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag20=settag21=settag22=settag23=0;
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >164 && location.y <194 && settag20==0)
        {
            [self PlaySound:@"A Long"];
            
            settag20=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag21=settag22=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >123 && location.y <163 && settag21==0)
        {
            [self PlaySound:@"A# Long"];
            
            settag21=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag22=settag23=0;
            if (settag == 22)
            {
                if ([allTouches count] > 1)
                {
        ...
        else if (location.y >75 && location.y <124 && settag22==0)
        {
            [self PlaySound:@"B Long"];
            
            settag22=1;
            settag11=settag12=settag13=settag14=settag15=settag16=settag17=settag18=settag19=settag20=settag21=settag23=0;
            [C setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [D setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [E setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
            [F setImage:[UIImage imageNamed:@"BigKeyVertc.png"]];
        ...
        else if (location.y >5 && location.y <73 && settag23==0)
        {
            [self PlaySound:@"C High"];
...
-(IBAction)btnStartRecoPressed:(id)sender
{
    ...
    imgVerify.frame=CGRectMake(131, 115 + 44, 104, 249);
    [ArrySetPasscode removeAllObjects];
    TimerImg.hidden=NO;
    settag=[sender tag];
    [self countdownTimer];
...
-(IBAction)btnVerifyPressed:(id)sender
{
    if (ReVerifySet==0)
    {
        ...
        {
            //imgVerify.image=[UIImage imageNamed:@"singlereverify.png"];
            // imgVerify.frame=CGRectMake(90, 117, 102, 247);
        }
        else
        {
            
            imgVerify.image=[UIImage imageNamed:@"IncorrectVerificationPopUp.png"];
            imgVerify.frame=CGRectMake(93, 115 + 44, 142, 249);
        }
        ReVerifySet=1;
    }
    else
...
{
    ViewPassRecovery.frame = CGRectMake(0, 0, 320, 568);
