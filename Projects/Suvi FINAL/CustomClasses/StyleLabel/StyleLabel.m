...
- (void)setFrame:(CGRect)aFrame {
    ...
    if (self.tag==112) {
        frame = CGRectMake(5+((42-textSize.width)/2),aFrame.origin.y,textSize.width,17);
    }
    else if(self.tag==113)
    {
        frame = CGRectMake(4+((42-textSize.width)/2),aFrame.origin.y,textSize.width,17);
    }
    else if(self.tag==114)
    {
        frame = CGRectMake(102,aFrame.origin.y,218,15);
    }
    else
    {
        frame = CGRectMake(102,aFrame.origin.y,178,15);
    }
//    else
//    {
